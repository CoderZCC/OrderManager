...
class PhotoBrowerTool: UIView {
    ...
    func hiddenPhoto() {
        ...
        if let originalFrame = self.originalFrame {
            ...
            UIView.animate(withDuration: 0.2, animations: {
                ...
                self.falseImgV.contentMode = .scaleAspectFill
                self.falseImgV.clipsToBounds = true
    ...
    @objc func saveAction() {
        ...
        if let img: UIImage = cell.imageView.image {
            ...
            AuthorityTool.saveMediaToAlbum(img: img) { (isOK) in
...
extension PhotoBrowerTool: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let object = object as? ThemeModel {
            
            cell.imageView.k_setImage(url: object.themeImgUrl)
        }        
        cell.clickCallBack = {
