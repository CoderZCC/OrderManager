...
class DatePickerTool: UIView {
    ...
    ///   - maximumDate: 最大时间
    ///   - callback: 选中回调
    static func showDatePickView(showModel: UIDatePicker.Mode, currentTime: Date? = kNowDate, minimumDate: Date? = nil, maximumDate: Date? = kNowDate, callback: ((String)->Void)?) {
